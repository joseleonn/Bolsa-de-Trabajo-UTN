...
public partial class BolsaDeTrabajoUTNContext : DbContext
{
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        modelBuilder.Entity<Admins>(entity =>
        {
            ...
            entity.HasOne(d => d.RolAdminNavigation).WithMany(p => p.Admins)
        ...
        modelBuilder.Entity<EmpresasPuestos>(entity =>
        {
            ...
            entity.HasOne(d => d.IdEmpresaNavigation).WithMany(p => p.EmpresasPuestos)
                .HasForeignKey(d => d.IdEmpresa)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("FK_Empresas_Puestos_Empresas");

            entity.HasOne(d => d.IdPuestosDeTrabajoNavigation).WithMany(p => p.EmpresasPuestos)
                .HasForeignKey(d => d.IdPuestosDeTrabajo)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("FK_Empresas_Puestos_PuestosDeTrabajo");
        });
        ...
        modelBuilder.Entity<Postulaciones>(entity =>
        {
            ...
            entity.HasOne(d => d.DniAlumnoNavigation).WithMany(p => p.Postulaciones)
                .HasForeignKey(d => d.DniAlumno)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("FK_Postulaciones_Alumnos");

            entity.HasOne(d => d.EstadoNavigation).WithMany(p => p.Postulaciones)
        ...
        modelBuilder.Entity<PuestosDeTrabajoPostulaciones>(entity =>
        {
            ...
            entity.HasOne(d => d.IdPostulacionNavigation).WithMany(p => p.PuestosDeTrabajoPostulaciones)
                .HasForeignKey(d => d.IdPostulacion)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("FK_PuestosDeTrabajo_Postulaciones_Postulaciones");

            entity.HasOne(d => d.IdPuestoDeTrabajoNavigation).WithMany(p => p.PuestosDeTrabajoPostulaciones)
